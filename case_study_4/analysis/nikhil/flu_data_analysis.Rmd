...
ARMA(2,0) seems to be on the top of the list using both AIC and BIC for flu_s52_d1. We will use this going forward
ARMA(3,1) seems to be on the top of the list using both AIC and BIC for est_s52. We will use this going forward
