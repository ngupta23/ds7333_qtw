...
ggplot2::ggplot(data=offlineSummary #filter(offlineSummary,angle==0 & mac=='00:0f:a3:39:e1:c0')
                ,aes(x=dist, y=signal)) +
  geom_point(size=0.1) +
  geom_smooth()+
...
diffs = offlineSummary[,c("posX", "posY")] -  AP[ offlineSummary$mac, ]
offlineSummary$dist = sqrt(diffs[ , 1]^2 + diffs[ , 2]^2)
ggplot2::ggplot(data=offlineSummary #filter(offlineSummary,angle==135 & mac=='00:0f:a3:39:e1:c0')
