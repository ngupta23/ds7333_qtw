...
Loading the CSV data generated from the python web scraper code.
...
## Analyzing Cherry Blossom 10M Women Race Results data

Number of participants across the years 1999 and 2012.
...
## Average age of participants across the years 1999 and 2012
...
raceResults <- raceResults %>% replace_with_na(replace = list(Division = "NR",Age="NR",Pid="NR",Tid="NR",Hometown="NR",Country="NR"))
head(raceResults)
gg_miss_upset(raceResults)
vis_miss(raceResults,warn_large_data=F,sort_miss=T)

```

## Analyzing Women Divisions in dataset
```{r }
